    ...
    return (
        <div>
          <div className="flex flex-col py-5 px-10 rounded-xl my-3 bg-mvx-bg-gray justify-center">
            <h2 className="flex font-medium group text-sm text-gray-300">Whitelisted Tokens</h2>
            <div className="mt-5">
          ...
          <div className="flex flex-col py-5 px-10 rounded-xl my-3 bg-mvx-bg-gray justify-center">
            <h2 className="flex font-medium group text-sm text-gray-300">Whitelist Token</h2>
            <div className="mt-5">
              <div className="flex items-center gap-5">
                ...
                <button className="w-1/2 bg-mvx-blue hover:scale-110  text-mvx-button-text  py-3 px-6 rounded-lg text-sm font-normal" onClick={() => whitelistToken(token)}>Whitelist Token</button>
              </div>
            </div>
          </div>
